...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
        <li class="nav-item active">
          <a class="nav-link" href="admin.php"><i class="fa fa-fw fa-home"></i> Home <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
  ...
  <div class="container"> 
    ...
    <div class="w3-default w3-hover-shadow w3-center">
  	  <a href="addques.php?ques=cssques&ans=cssans" style="text-decoration: none"><i style="font-size: 20px">Add questions to the CSS Quiz  >> </i></a>
  	</div><br>
  	<div class="w3-default w3-hover-shadow w3-center">
  	  <a href="addques.php?ques=phpques&ans=phpans" style="text-decoration: none"><i style="font-size: 20px">Add questions to the PHP Quiz  >> </i></a>
    </div><br>
    <div class="w3-default w3-hover-shadow w3-center">
      <a href="addques.php?ques=jsques&ans=jsans" style="text-decoration: none"><i style="font-size: 20px">Add questions to the JS Quiz >> </i></a>
    </div>
  </div>
  <!--<button style="margin-left: 80%" name="click" class="btn btn-primary">Add New Quiz</button>-->
</body>
</html>